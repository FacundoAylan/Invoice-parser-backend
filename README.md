# Invoice Parser Backend (Fork / Copy)

> ℹ️ **Nota sobre este repositorio:**  
> Este repositorio es una copia (fork/mirror) realizada para trabajar en colaboración con **Nahuel Lescano** y desplegar el entorno de backend.  
> 🔗 **Repositorio original:** [NahuelLescano/Invoice-parser-backend](https://github.com/NahuelLescano/Invoice-parser-backend)
